    ...
    return (
        <div ref={ref} className="fixed top-5 right-5 z-50">
            ...
            <button
                ...
                className="w-14 h-14 rounded-full bg-accent/80 text-fg flex items-center justify-center hover:bg-accent transition-all duration-200 cursor-pointer shadow-lg backdrop-blur-sm"
            >
